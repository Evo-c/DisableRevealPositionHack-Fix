...
public final static func RevealPlayerPositionIfNeeded(ownerPuppet: wref<ScriptedPuppet>, playerID: EntityID, opt isPrevention: Bool) -> Bool {
    ...
    let isNetrunner: Bool = ArrayContains([gamedataArchetypeType.NetrunnerT1, gamedataArchetypeType.NetrunnerT2, gamedataArchetypeType.NetrunnerT3],archetypeName);
